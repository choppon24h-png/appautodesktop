                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">Contas a Pagar</h5>
                                    <span class="h2 font-weight-bold mb-0">R$ 924,00</span>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">Contas a Receber</h5>
                                    <span class="h2 font-weight-bold mb-0">R$ 49.650,00</span>
                                </div>
                                <div class="col-auto">
